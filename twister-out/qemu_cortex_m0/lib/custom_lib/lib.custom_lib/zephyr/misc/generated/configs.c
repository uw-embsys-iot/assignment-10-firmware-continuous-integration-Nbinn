...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_LIB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_LIB_GET_VALUE_DEFAULT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ASSIGNMENT_9_MODULE, 1);
